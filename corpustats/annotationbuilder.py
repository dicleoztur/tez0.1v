...
class AnnotationBuilder():
    ...
    def __init__(self, ntexts, psingle, poverlaps, nusers, months, resources, cats, corpuspath, outfolder):
        ...
        self.nsingle = int(self.ntexts * psingle)
        self.noverlaps = int(self.ntexts * poverlaps)
        self.ncoders = nusers
    ...
    def generate_evalutation_table(self, tablefolder, usertextpairs):
        evaluationtable = [("evaluationid", "userid", "questionname", "answer")]
        
        for i,(uid,qname) in enumerate(usertextpairs):
            evaluationtable.append((i, uid, qname, -100))
...
if __name__ == "__main__":
    ...
    testbuilder = AnnotationBuilder(ntexts = 10, 
                                    ...
                                    outfolder="/home/dicle/Dicle/Tez/corpusstats/annotatable/dists/"
                                    )
